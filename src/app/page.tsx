...
import { ScrollIndicator,useScrollAnimation,AnimateOnScroll } from "@/lib/ScrollUtils";
      ...
      <div className="relative -mt-24 md:-mt-24 xl:-mt-48 md:px-4 lg:px-8 z-40">
        ...
        <div className="md:max-w-4xl w-full mx-auto bg-white shadow-lg md:rounded-3xl p-6 mb-8">
          ...
          <div className="text-center pb-4">
            ...
            <Link href="/staff">
              <Button className="bg-white text-[#4A90E2] hover:bg-[#4A90E2] hover:text-white border-2 border-[#4A90E2] rounded-full px-4 py-1 text-sm inline-flex items-center gap-2 transition-colors duration-200">
                Meet the Full Team
